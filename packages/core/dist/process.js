 ...
 */
export function computeIntensity(lum, alpha, mode, threshold, invert) {
    if (mode === "alpha") {
        const a = alpha / 255;
 ...
 */
export function pixelBufferToGrid(pixels, options) {
